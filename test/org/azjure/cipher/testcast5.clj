...
(ns org.azjure.cipher.testcast5
  ...
  (:require [clojure.test :refer :all]
            ...
            [org.azjure.cryptsuite :refer [->CAST5CBCISO10126
                                           ->CAST5CBCISO7816
                                           ->CAST5CBCPKCS7
                                           ->CAST5CBCX923
                                           ->CAST5CBCZERO ->CAST5CFB
                                           ->CAST5CTR
                                           ->CAST5ECBISO10126
                                           ->CAST5ECBISO7816
                                           ->CAST5ECBPKCS7
                                           ->CAST5ECBX923
                                           ->CAST5ECBZERO ->CAST5OFB
                                           ->CAST5PCBCISO10126
                                           ->CAST5PCBCISO7816
                                           ->CAST5PCBCPKCS7
                                           ->CAST5PCBCX923
...
(def ^{:doc "Test vectors for CAST5 block suites"} c5block-test-vectors
  [[CAST5ECBPKCS7 initmap phrase [0x34 0xE1 0xB3 0xFC 0x0D 0x72 0xF1 0xD8
   ...
   [CAST5ECBZERO initmap phrase [0x34 0xE1 0xB3 0xFC 0x0D 0x72 0xF1 0xD8
                                 0x5D 0x83 0x71 0x26 0x6E 0x69 0xCC 0x65
                                 0x77 0x22 0x29 0x60 0x66 0x85 0xB5 0xD2
                                 0x03 0x82 0x26 0x55 0xFF 0xFD 0x91 0x70
                                 0x56 0x1C 0x92 0x6F 0x8F 0xCE 0xDD 0x2B
                                 0xF9 0xBC 0xAB 0x93 0x89 0xB4 0x80 0x66]]
   [CAST5ECBX923 initmap phrase [0x34 0xE1 0xB3 0xFC 0x0D 0x72 0xF1 0xD8
                                 0x5D 0x83 0x71 0x26 0x6E 0x69 0xCC 0x65
                                 0x77 0x22 0x29 0x60 0x66 0x85 0xB5 0xD2
                                 0x03 0x82 0x26 0x55 0xFF 0xFD 0x91 0x70
                                 0x56 0x1C 0x92 0x6F 0x8F 0xCE 0xDD 0x2B
                                 0xFE 0xF0 0xBD 0x65 0xB7 0x91 0xC4 0xA0]]
   [CAST5ECBISO7816 initmap phrase [0x34 0xE1 0xB3 0xFC 0x0D 0x72 0xF1 0xD8
                                    0x5D 0x83 0x71 0x26 0x6E 0x69 0xCC 0x65
                                    0x77 0x22 0x29 0x60 0x66 0x85 0xB5 0xD2
                                    0x03 0x82 0x26 0x55 0xFF 0xFD 0x91 0x70
                                    0x56 0x1C 0x92 0x6F 0x8F 0xCE 0xDD 0x2B
                                    0x07 0x8E 0xC9 0xBD 0x3A 0xFE 0xA3 0xB1]]
   [CAST5CBCPKCS7 initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
   ...
   [CAST5CBCZERO initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
                                 0xCC 0x98 0xB4 0x94 0x3C 0x2A 0xAB 0xA8
                                 0x16 0x86 0xE0 0xF8 0xB5 0x64 0x41 0x55
                                 0x80 0x1C 0xDE 0x0F 0x9E 0x61 0x80 0x4A
                                 0xE8 0x17 0xD3 0x65 0xD1 0x7C 0x0F 0x79
                                 0x66 0x19 0x9D 0xE4 0xCD 0xA2 0x2B 0xD7]]
   [CAST5CBCX923 initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
                                 0xCC 0x98 0xB4 0x94 0x3C 0x2A 0xAB 0xA8
                                 0x16 0x86 0xE0 0xF8 0xB5 0x64 0x41 0x55
                                 0x80 0x1C 0xDE 0x0F 0x9E 0x61 0x80 0x4A
                                 0xE8 0x17 0xD3 0x65 0xD1 0x7C 0x0F 0x79
                                 0x36 0x25 0xFE 0x14 0x83 0xDE 0xA8 0xF1]]
   [CAST5CBCISO7816 initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
                                    0xCC 0x98 0xB4 0x94 0x3C 0x2A 0xAB 0xA8
                                    0x16 0x86 0xE0 0xF8 0xB5 0x64 0x41 0x55
                                    0x80 0x1C 0xDE 0x0F 0x9E 0x61 0x80 0x4A
                                    0xE8 0x17 0xD3 0x65 0xD1 0x7C 0x0F 0x79
                                    0x4D 0xAD 0x2A 0x5B 0xCE 0xCD 0xFD 0xE1]]
   [CAST5PCBCPKCS7 initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
   ...
   [CAST5PCBCZERO initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
                                  0x3E 0x17 0x76 0x26 0x96 0x2A 0x80 0x80
                                  0x51 0x63 0x89 0xDF 0x36 0x58 0x69 0x65
                                  0xEA 0x7F 0xA3 0x1D 0x65 0x11 0x76 0xE4
                                  0x91 0xFC 0x0D 0xEC 0x18 0x6C 0x43 0x9F
                                  0x04 0x2B 0xE0 0x5E 0xC4 0xAD 0x62 0x78]]
   [CAST5PCBCX923 initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
                                  0x3E 0x17 0x76 0x26 0x96 0x2A 0x80 0x80
                                  0x51 0x63 0x89 0xDF 0x36 0x58 0x69 0x65
                                  0xEA 0x7F 0xA3 0x1D 0x65 0x11 0x76 0xE4
                                  0x91 0xFC 0x0D 0xEC 0x18 0x6C 0x43 0x9F
                                  0xB4 0xEE 0x2A 0x31 0xA2 0xC6 0x88 0xF8]]
   [CAST5PCBCISO7816 initmap phrase [0xE5 0x7C 0x6E 0x4A 0xD9 0x1C 0xA5 0xB4
                                     0x3E 0x17 0x76 0x26 0x96 0x2A 0x80 0x80
                                     0x51 0x63 0x89 0xDF 0x36 0x58 0x69 0x65
                                     0xEA 0x7F 0xA3 0x1D 0x65 0x11 0x76 0xE4
                                     0x91 0xFC 0x0D 0xEC 0x18 0x6C 0x43 0x9F
...
(def ^{:doc "Test vectors for CAST5 stream suites"} c5s-test-vectors
  [[CAST5CFB initmap phrase [0x4C 0xA5 0x30 0x3F 0x0E 0xEB 0x35 0x35
                             ...
                             0x57 0xA8 0x4D 0x91]]
   [CAST5OFB initmap phrase [0x4C 0xB2 0x1F 0xC2 0x78 0x14 0x15 0x72
...
(def ^{:doc "Test vectors for CAST5 counter mode suite"} c5ctr-test-vectors
  [[CAST5CTR initmap phrase [0x76 0xCF 0xA2 0x28 0x36 0xC1 0xEA 0x48
...
(deftest ^{:doc "Test CAST5 block suites"} testBlock
  (testing "Block"
    (is (= true (every? true? (map #(encryptor % :iv iv-64b) c5block-test-vectors))))
    (is (= true (every? true? (map #(decryptor % :iv iv-64b) c5block-test-vectors))))))
