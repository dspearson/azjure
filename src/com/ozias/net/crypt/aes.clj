...
;; </tr>
;; <tr>
;; <td style="border: 1px solid black;">AES-192</td>
;; <td style="border: 1px solid black;text-align: center;">6</td>
;; <td style="border: 1px solid black;text-align: center;">4</td>
;; <td style="border: 1px solid black;text-align: center;">12</td>
;; </tr>
;; <tr>
;; <td style="border: 1px solid black;">AES-256</td>
...
;;
;; to lookup the substition value for X, where X is a byte.
(def Sbox
...
;; ### invSbox
;; Substitution box used during decryption as a vector of 256 bytes.
;;
;; Use
;;
;;     (nth invSbox (bit-and X 0xFF))
;;
;; to lookup the substition value for X, where X is a byte.
(def invSbox
...
(def x11gf256
  (vector 0x00 0x0b 0x16 0x1d 0x2c 0x27 0x3a 0x31
...
(def x13gf256
  (vector 0x00 0x0d 0x1a 0x17 0x34 0x39 0x2e 0x23
...
(def x14gf256
  (vector 0x00 0x0e 0x1c 0x12 0x38 0x36 0x24 0x2a
