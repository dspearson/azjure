...
;; [http://www.schneier.com/code/vectors.txt](http://www.schneier.com/code/vectors.txt)
;;
;; Each row represents
;;
...
(defn- test-encrypt [[key cleartext ciphertext]]
  (is (= ciphertext (bc/encrypt-block bf cleartext key))))

;; ## test-decrypt
;; Helper function for Blowfish decryption testing
(defn- test-decrypt [[key cleartext ciphertext]]
  (is (= cleartext (bc/decrypt-block bf ciphertext key))))
