...
;; [RFC 2144](http://tools.ietf.org/html/rfc2144#appendix-B.1)
(def key-128b [0x01 0x23 0x45 0x67 0x12 0x34 0x56 0x78
               0x23 0x45 0x67 0x89 0x34 0x56 0x78 0x9a])

(def tf-128-key [0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00
                 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00])

(def tf-192-key [0x01 0x23 0x45 0x67 0x89 0xAB 0xCD 0xEF
                 0xFE 0xDC 0xBA 0x98 0x76 0x54 0x32 0x10
                 0x00 0x11 0x22 0x33 0x44 0x55 0x66 0x77])

(def tf-256-key (into tf-192-key [0x88 0x99 0xAA 0xBB 0xCC 0xDD 0xEE 0xFF]))
