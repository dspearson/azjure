...
(def ^{:private true
       :doc     "Subkey generation steps"}
  sks0 [0x00000000 0x02020202 0x04040404 0x06060606
...
(def ^{:private true
       :doc     "Subkey generation steps"}
  sks1 [0x01010101 0x03030303 0x05050505 0x07070707
...
(def ^{:private true
       :doc     "An array of q constants"}
  qarr [qvec0 qvec1 qvec2 qvec3 qvec4])
...
(defn- h
  "The h function as defined in
  [Section 4.3.2](http://www.schneier.com/paper-twofish-paper.pdf). Evaluates to
  a function over the mds and a list of words.
...
(def ^{:private true
       :doc     "Memoization of boddsfn"}
  bodds (memoize boddsfn))
...
(def ^{:private true
       :doc     "Memoization of even-subkeysfn"}
  even-subkeys (memoize even-subkeysfn))
...
(defn- f
  "The function f as defined in
  [Section 4.1](http://www.schneier.com/paper-twofish-paper.pdf) of the Twofish
  paper.  Takes two input 32-bit words, the key schedule, the S-box values,
  and the round
